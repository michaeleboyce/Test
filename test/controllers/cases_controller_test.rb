...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { case_number: @case.case_number, country: @case.country, date_fled: @case.date_fled }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { case_number: @case.case_number, country: @case.country, date_fled: @case.date_fled }
    assert_redirected_to case_path(assigns(:case))
  end
